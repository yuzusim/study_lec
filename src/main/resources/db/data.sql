...
insert into user_tb(my_name, password, email, phone, address, birth, photo, role, created_at) values('주호최', '1234', 'cos@nate.com', '010-2222-7733', '광주', '1987-05-10', 'cos_img.png', 1, now());
...
-- 공고 테이블
INSERT INTO jobs_tb(user_id, area, edu, career, skill_id, content, dead_line, task, created_at) VALUES (4, '부산', '학력무관', '미들(4~8년)', 1, '성실하고 열심히 일하실 분 모집!', '2024-03-10', '백엔드', NOW());
INSERT INTO jobs_tb(user_id, area, edu, career, skill_id, content, dead_line, task, created_at) VALUES (4, '서울', '4년제', '신입', 2, '성실하고 열심히 일하실 분 모집!', '2024-05-22', '백엔드', NOW());
INSERT INTO jobs_tb(user_id, area, edu, career, skill_id, content, dead_line, task, created_at) VALUES (4, '울산', '학력무관', '시니어(10년 이상)', 3, '성실하고 열심히 일하실 분 모집!', '2024-04-09', '백엔드', NOW());
INSERT INTO jobs_tb(user_id, area, edu, career, skill_id, content, dead_line, task, created_at) VALUES (5, '부산', '학력무관', '신입', 4, '성실하고 열심히 일하실 분 모집!', '2024-03-29', '백엔드', NOW());
